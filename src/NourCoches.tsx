...
const TRANSLATIONS = {
    ar: {
        ...
        hero: {
            ...
            desc: 'في نوركوشيس، استمتع بأفضل السيارات بأفضل الأسعار. جودة استثنائية وخدمة عملاء مصممة خصيصاً لراحتك أثناء إقامتك في طنجة.',
        ...
        whyUs: {
            ...
            desc: 'في نوركوشيس، نقدم لك مزيجاً متكاملاً من السيارات الاستثنائية، الأسعار التنافسية، وخدمة العملاء المبتكرة. كل مركبة في أسطولنا تعكس التزامنا بأعلى معايير الجودة لضمان تجربة لا مثيل لها.',
            cta: 'تواصل معنا 📞',
            cars: 'سيارة متاحة',
            clients: 'عميل سعيد',
            support: 'دعم العملاء',
        ...
        footer: {
            about: 'نوركوشيس الرائدة في تأجير السيارات الفاخرة والاقتصادية في طنجة. نلتزم بتقديم أفضل تجربة لعملائنا منذ عام 2019.',
    ...
    fr: {
        ...
        hero: {
            ...
            desc: 'Chez Norcoches, profitez des meilleures voitures au meilleur prix. Une qualité exceptionnelle et un service client sur-mesure pour votre séjour à Tanger.',
        ...
        whyUs: {
            ...
            desc: 'Chez Norcoches, nous redéfinissons la location de voitures avec des véhicules d\'exception à des prix imbattables. Notre service innovant et notre exigence de qualité supérieure vous garantissent une expérience mémorable.',
            cta: 'Contactez-nous 📞',
        ...
        footer: {
            about: 'Norcoches, leader de la location de voitures à Tanger. Engagement qualité et innovation depuis 2019.',
    ...
    en: {
        ...
        hero: {
            ...
            desc: 'At Norcoches, experience the best cars at the best rates. Exceptional quality and tailored customer service for your stay in Tangier.',
        ...
        whyUs: {
            ...
            desc: 'At Norcoches, we deliver outstanding cars at unbeatable prices, backed by innovative customer service and top-tier quality standards to ensure your journey is perfect.',
            cta: 'Contact Us 📞',
            cars: 'Available cars',
        ...
        footer: {
            about: 'Norcoches, the leading premium and economy car rental agency in Tangier. Committed to excellence and innovation since 2019.',
...
export default function NourCoches({ carSlug }: { carSlug?: string }) {
    ...
    useEffect(() => {
        ...
        const loadDb = async () => {
            ...
            try {
                ...
                if (!isCancelled) {
                    setDb(backup);
                    setDbError('API unavailable. Loaded local backup data.');
                }
                return;
            } catch (err) {
            ...
            if (!isCancelled) {
                setDb(EMPTY_DB);
                setDbError('Data service unavailable. Showing limited view.');
            }
        };
        ...
        <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', animation: 'fadeIn 1s ease' }}>
                <div style={{
                    ...
                    padding: '10px', background: 'rgba(230,0,0,0.05)',
                    borderRadius: '24px', border: '1px solid rgba(230,0,0,0.2)',
                    boxShadow: '0 20px 40px rgba(0,0,0,0.5)',
                    position: 'relative'
                }}>
                    <div style={{ position: 'absolute', inset: -5, borderRadius: '28px', border: '1px solid rgba(230,0,0,0.1)', animation: 'pulse 2s infinite' }} />
                    <img src={logo} alt="Logo" style={{ width: '100%', height: '100%', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(230,0,0,0.4))' }} />
                </div>
    ...
    const WA_MSG = encodeURIComponent(lang === 'ar' ? "مرحباً نوركوشيس! أود حجز سيارة. ما هي المواعيد المتاحة؟" : "Bonjour Norcoches ! Je souhaite réserver une voiture. Quelles sont vos disponibilités ?");
    ...
    return (
        <div dir={t('dir')} style={{ background: '#0a0a0a', color: '#fff', fontFamily: t('font'), overflowX: 'hidden' }}>
            {dbError && (
                <div style={{
                    position: 'fixed',
                    top: 0,
            ...
            <nav style={{
                ...
                borderBottom: navSolid ? '1px solid rgba(230,0,0,0.12)' : 'none',
                ...
                {db?.promoCars?.length > 0 && (
                    <div onClick={() => setShowPromoModal(true)} style={{
                        background: 'linear-gradient(90deg, #b30000, #ff4d4d, #e60000, #ff4d4d, #b30000)',
                ...
                <div style={{ maxWidth: 1200, margin: '0 auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 2rem', height: navSolid ? '70px' : '88px', transition: 'all 0.45s ease' }}>
                    ...
                    <a href="#" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <div style={{ fontWeight: 900, fontSize: '1.25rem', letterSpacing: '0.5px', color: '#e60000', lineHeight: 1.2 }}>{lang === 'ar' ? 'نوركوشيس' : 'Norcoches'}</div>
                    ...
                    <div className="desktop-nav" style={{
                        ...
                        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                            ...
                            <a href={FB} target="_blank" rel="noreferrer" style={{ color: 'rgba(255,255,255,0.6)', transition: 'color 0.3s' }} onMouseEnter={e => e.currentTarget.style.color = '#e60000'} onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.6)'}>
                                <Facebook size={20} />
                            </a>
                        ...
                        {db?.promoCars?.length > 0 && (
                            <button onClick={() => setShowPromoModal(true)} style={{
                                ...
                                onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.05) translateY(-1px)'; e.currentTarget.style.boxShadow = '0 0 25px rgba(230,0,0,0.5)'; }}
                                onMouseLeave={e => { e.currentTarget.style.transform = 'scale(1) translateY(0)'; e.currentTarget.style.boxShadow = '0 0 15px rgba(230,0,0,0.3)'; }}>
                        ...
                        <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                            <select
                                ...
                                style={{
                                    background: 'transparent', color: '#e60000', border: 'none',
                            ...
                            <span style={{ position: 'absolute', right: 0, pointerEvents: 'none', color: '#e60000', fontSize: '0.7rem' }}>▼</span>
                        ...
                        <div style={{ display: 'flex', background: 'rgba(255,255,255,0.05)', padding: '4px', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)' }}>
                            {(['ar', 'fr', 'en'] as const).map((l) => (
                                <button
                                    ...
                                    onClick={() => setLang(l)}
                                    style={{
                                        background: lang === l ? '#e60000' : 'transparent',
                    ...
                    <button
                        ...
                        style={{
                            display: 'none', background: 'rgba(230,0,0,0.1)', border: '1px solid rgba(230,0,0,0.3)',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6, width: 24 }}>
                            <div style={{ height: 2, background: '#e60000', width: '100%' }} />
                            <div style={{ height: 2, background: '#e60000', width: '80%', alignSelf: t('dir') === 'rtl' ? 'flex-start' : 'flex-end' }} />
                            <div style={{ height: 2, background: '#e60000', width: '100%' }} />
                        </div>
                    </button>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                        ...
                        {db?.promoCars?.length > 0 && (
                            <button onClick={() => { setShowPromoModal(true); setMobileMenuOpen(false); }} style={{
                                ...
                                boxShadow: '0 5px 20px rgba(230,0,0,0.25)',
                                animation: 'pulse 2s infinite',
                                fontFamily: 'inherit'
                            }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                ...
                                <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: '0.7rem', position: 'relative', border: '1px solid rgba(255,255,255,0.08)' }}>
                                    ...
                                    <span style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', color: '#e60000', fontSize: '0.6rem' }}>▼</span>
                                </div>
                            </div>
                                ...
                                <div style={{ display: 'flex', gap: '4px', background: 'rgba(255,255,255,0.05)', padding: '4px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.08)' }}>
                                    {(['ar', 'fr', 'en'] as const).map((l) => (
                                        <button
                                            ...
                                            onClick={() => setLang(l)}
                                            style={{
                                                flex: 1, background: lang === l ? '#e60000' : 'transparent',
                                                color: '#fff', border: 'none',
            ...
            <section ref={heroRef} className="hero-section" style={{ minHeight: '100vh', height: 'auto', position: 'relative', display: 'flex', alignItems: 'center', transition: 'all 0.3s' }}>
                ...
                <div className="hero-content" style={{
                    ...
                    <h1 style={{
                        ...
                        <span style={{ color: '#fff' }}>{db?.storeName?.split(' ')[0] || 'NORCOCHES'}</span>{' '}
                        <span style={{ color: '#e60000' }}>{db?.storeName?.split(' ').slice(1).join(' ') || 'CAR'}</span>
                    </h1>
                    ...
                    <div style={{
                        ...
                        <div className="search-date-field" style={{ flex: 1, minWidth: 140, padding: '1rem 1.2rem', borderRight: '1px solid #ddd', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <div style={{ fontSize: '0.75rem', color: '#e60000', fontWeight: 900, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 }}>
            ...
            <section id="flotte" style={{ padding: '7rem 2rem' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <div style={{ color: '#e60000', fontSize: '0.9rem', fontWeight: 700, marginBottom: '1rem' }}>— {t('fleet.title')} —</div>
                        <h2 style={{ fontWeight: 900, fontSize: 'clamp(2rem,5vw,3.2rem)', marginBottom: '1rem' }}>
                            {t('fleet.subtitle1')}{' '}
                            <span style={{ background: 'linear-gradient(90deg,#b30000,#e60000)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{t('fleet.subtitle2')}</span>
                        </h2>
                            ...
                            return (
                                <div key={car.id}
                                    ...
                                    style={{
                                        ...
                                        border: `1px solid ${hovered === car.id ? '#e60000' : '#e8e8e8'}`,
                                        overflow: 'hidden', cursor: 'default',
                                        display: 'flex', flexDirection: 'column', alignItems: 'stretch',
                                        boxShadow: hovered === car.id ? '0 8px 30px rgba(230,0,0,0.15)' : '0 2px 12px rgba(0,0,0,0.08)',
                                ...
                                >
                                    ...
                                    <div className="fleet-card-img" style={{ width: '100%', height: 160, flexShrink: 0, position: 'relative', background: '#f7f7f7', overflow: 'hidden', cursor: car.img ? 'pointer' : 'default' }}
                                        ...
                                        {isPromo && (
                                            <div className="promo-badge shimmer-bg" style={{
                                                ...
                                                background: 'linear-gradient(135deg, #b30000 0%, #ff3b3b 50%, #b30000 100%)',
                                    ...
                                    <div className="fleet-card-info" style={{ flex: 1, padding: '1rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                        ...
                                        <div>
                                            ...
                                            {/* Stars */}
                                            <div className="stars-row" style={{ color: '#e60000', fontSize: '0.85rem', marginBottom: 8 }}>★★★★★</div>
                                        ...
                                        <div>
                                            <div className="price-row" style={{ marginBottom: 10 }}>
                                                ...
                                                {isPromo ? (
                                                    <>
                                                        <span className="price-val" style={{ fontWeight: 900, fontSize: '1.5rem', color: '#ff3b3b', textShadow: '0 0 10px rgba(255,59,59,0.5)', animation: 'pulseText 2s infinite' }}>{formatPrice(promoData.price)} {currency}</span>
                                            ...
                                            <div className="btn-row" style={{ display: 'flex', gap: 8 }}>
                                                <button
                                                    ...
                                                    style={{
                                                        flex: 1, background: (!car.count || car.count <= 0) ? '#555' : '#e60000', color: '#fff',
                                                    ...
                                                    onMouseLeave={e => { if (car.count > 0) e.currentTarget.style.background = '#e60000'; }}
                                                >
                                                ...
                                                {car.img && (
                                                    <button
                                                        ...
                                                        onMouseEnter={e => { e.currentTarget.style.background = '#fde8e8'; e.currentTarget.style.color = '#e60000'; }}
                                                ...
                                                {db?.promoCars?.some((p: any) => L(p.name) === L(car.name)) && (
                                                    <button
                                                        ...
                                                        style={{ background: '#fff5f5', color: '#e60000', border: '1px solid #fca5a5', padding: '0.65rem 0.9rem', borderRadius: 8, cursor: 'pointer', fontSize: '0.85rem', animation: 'bounceSmall 2s infinite' }}
                                                        title="Promotion"
                                                    >🎁</button>
                                                )}
                                            </div>
                            ...
                            {(db.carsForSale || []).map((car: any) => (
                                ...
                                >
                                    ...
                                    <div className="fleet-card-info" style={{ flex: 1, padding: '1rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                        ...
                                        <div>
                                            <div style={{ fontWeight: 900, fontSize: '1.35rem', color: '#ff3b3b', marginBottom: '6px', animation: 'pulseText 2s infinite' }}>
                                                {car.salePrice?.toLocaleString()} <span style={{ fontSize: '0.75rem', color: 'rgba(255,255,255,0.35)' }}>DH</span>
                                            </div>
                                            <button style={{
                                                width: '100%', background: 'linear-gradient(45deg, #b30000, #e60000)', color: '#fff',
            ...
            <section style={{ padding: '7rem 2rem', background: '#080808', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
                <div className="why-us-flex" style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: '4rem', flexWrap: 'wrap', alignItems: 'center' }}>
                    <div style={{ flex: '1 1 500px' }}>
                        <div style={{ color: '#e60000', fontSize: '0.9rem', fontWeight: 700, marginBottom: '1rem' }}>— {t('whyUs.title')} —</div>
                        <h2 style={{ fontWeight: 900, fontSize: 'clamp(2rem,5vw,3rem)', marginBottom: '1.5rem', lineHeight: 1.2 }}>
                            {t('whyUs.subtitle1')}<br />
                            <span style={{ background: 'linear-gradient(90deg,#b30000,#e60000)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>{t('whyUs.subtitle2')}</span>
                        </h2>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                            {[
                                ...
                                <div key={l}>
                                    <div style={{ fontWeight: 900, fontSize: '1.5rem', color: '#e60000', marginBottom: 4 }}>{v}</div>
                    ...
                    <div style={{ flex: '1 1 400px', position: 'relative' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: -20, left: t('dir') === 'rtl' ? 'auto' : -20, right: t('dir') === 'rtl' ? -20 : 'auto', background: 'linear-gradient(45deg,#b30000,#e60000)', padding: '1.5rem 2rem', borderRadius: 20, boxShadow: '0 20px 40px rgba(230,0,0,0.3)', color: '#fff', fontWeight: 900, fontSize: '1.2rem' }}>
            ...
            <section id="avis" style={{ padding: '7rem 2rem', background: '#080808' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <div style={{ color: '#e60000', fontSize: '0.9rem', fontWeight: 700, marginBottom: '1rem' }}>— {lang === 'ar' ? 'آراء العملاء' : 'Testimonials'} —</div>
                    ...
                    <div className="reviews-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(400px,1fr))', gap: '2rem' }}>
                        {TESTIMONIALS.map((r) => (
                            <div key={r.name.en} style={{ background: '#121212', padding: '2.5rem', borderRadius: 24, border: '1px solid rgba(255,255,255,0.04)', position: 'relative' }}>
                                <div style={{ color: '#e60000', fontSize: '1.2rem', marginBottom: '1rem' }}>{'★'.repeat(r.stars)}</div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                    <div style={{ width: 48, height: 48, borderRadius: '50%', background: 'linear-gradient(45deg,#222,#444)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, color: '#e60000' }}>{r.name[lang][0]}</div>
                                    <div>
            ...
            <section style={{ padding: '7rem 2rem' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
                        <div style={{ color: '#e60000', fontSize: '0.9rem', fontWeight: 700, marginBottom: '1rem' }}>— {t('process.title')} —</div>
                        <h2 style={{ fontWeight: 900, fontSize: 'clamp(2rem,5vw,3rem)' }}>
                            {t('process.subtitle1')}<span style={{ color: '#e60000' }}>{t('process.subtitle2')}</span>
                        </h2>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: '3rem', flexWrap: 'wrap', position: 'relative' }}>
                        <div className="process-line" style={{ position: 'absolute', top: '40px', left: '10%', right: '10%', height: '2px', background: 'rgba(230,0,0,0.1)', zIndex: 0 }} />
                        {PROCESS.map((p) => (
                            <div key={p.step} style={{ flex: '1 1 280px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
                                <div style={{ width: 84, height: 84, borderRadius: 25, background: '#121212', border: '2px solid #e60000', color: '#e60000', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', fontWeight: 900, margin: '0 auto 1.8rem', boxShadow: '0 10px 30px rgba(230,0,0,0.15)' }}>{p.step}</div>
            ...
            <section style={{ padding: '7rem 2rem', background: '#080808' }}>
                <div style={{ maxWidth: 800, margin: '0 auto' }}>
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <div style={{ color: '#e60000', fontSize: '0.9rem', fontWeight: 700, marginBottom: '1rem' }}>— {t('faq.title')} —</div>
                        <h2 style={{ fontWeight: 900, fontSize: 'clamp(2rem,5vw,3rem)' }}>{t('faq.subtitle1')}<span style={{ color: '#e60000' }}>{t('faq.subtitle2')}</span></h2>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                        {FAQS.map((f) => (
            ...
            <section style={{
                ...
                borderTop: '1px solid rgba(230,0,0,0.18)', borderBottom: '1px solid rgba(230,0,0,0.18)',
            }}>
                <div style={{ maxWidth: 700, margin: '0 auto' }}>
                    <h2 style={{ fontWeight: 900, fontSize: 'clamp(1.8rem,4.5vw,3rem)', marginBottom: '0.8rem' }}>
                        {t('cta.title1')}<span style={{ color: '#e60000' }}>{t('cta.title2')}</span>{t('cta.title3')}
                    </h2>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        {[
                            ...
                            <a key={i} href={WA(p.num)} target="_blank" rel="noreferrer" style={{
                                background: 'linear-gradient(45deg,#b30000,#e60000)', color: '#fff',
                                ...
                                onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.transform = 'translateY(-3px)'; el.style.boxShadow = '0 12px 28px rgba(230,0,0,0.4)'; }}
                ...
                <section style={{ padding: '7rem 2rem', background: '#0a0a0a' }}>
                    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3.5rem', flexWrap: 'wrap', gap: '1rem' }}>
                            <div>
                                <div style={{ color: '#e60000', fontSize: '0.8rem', fontWeight: 700, marginBottom: '0.8rem', textTransform: 'uppercase', letterSpacing: 1 }}>— Blog & Astuces</div>
                                <h2 style={{ fontWeight: 900, fontSize: 'clamp(2rem,4vw,2.8rem)', margin: 0 }}>
                                    {lang === 'ar' ? 'أحدث' : 'Derniers'} <span style={{ color: '#e60000' }}>{lang === 'ar' ? 'المقالات' : 'Articles'}</span>
                                </h2>
                            </div>
                            <a href="/blog" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#fff', textDecoration: 'none', fontWeight: 800, fontSize: '0.9rem', borderBottom: '2px solid transparent', paddingBottom: 4, transition: 'all 0.3s' }}
                                onMouseEnter={e => e.currentTarget.style.borderBottomColor = '#e60000'}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '2rem' }}>
                            {db.posts.filter((p: any) => p.published).slice(0, 3).map((post: any) => (
                                <a key={post.id} href={`/blog/${post.slug}`} style={{ background: '#111', borderRadius: 20, overflow: 'hidden', textDecoration: 'none', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', transition: 'all 0.3s ease' }}
                                    onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.transform = 'translateY(-6px)'; el.style.boxShadow = '0 20px 40px rgba(0,0,0,0.5)'; el.style.borderColor = 'rgba(230,0,0,0.2)'; }}
                                    ...
                                    <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                        <div style={{ fontSize: '0.75rem', color: '#e60000', fontWeight: 800, marginBottom: '0.5rem', textTransform: 'uppercase' }}>
                                            {post.tags?.[0] || 'Article'}
                                        </div>
            ...
            <section id="contact" style={{ padding: '7rem 2rem', maxWidth: 1000, margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
                    <div style={{ color: '#e60000', fontSize: '0.8rem', fontWeight: 700, marginBottom: '1rem' }}>— {t('contact.title')} —</div>
                ...
                <div style={{ borderRadius: 22, overflow: 'hidden', border: '1px solid rgba(230,0,0,0.18)', boxShadow: '0 0 60px rgba(0,0,0,0.6)' }}>
                    <iframe
                        title="Localisation Norcoches"
                ...
                <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ fontWeight: 900, fontSize: '1.2rem', letterSpacing: '1px', color: '#e60000', lineHeight: 1.2 }}>{lang === 'ar' ? 'نوركوشيس' : 'Norcoches'}</div>
                    ...
                    <div style={{ color: 'rgba(255,255,255,0.15)', fontSize: '0.8rem' }}>© 2026 {lang === 'ar' ? 'نوركوشيس' : 'Norcoches'} · {t('footer.rights')} · {lang === 'ar' ? 'طنجة، المغرب' : 'Tangier, Morocco'}</div>
                </div>
            </footer>
            ...
            {showPromoModal && (
                <div style={{
                    ...
                    <div className="promo-modal-content" style={{
                        background: '#111', border: '1px solid rgba(230,0,0,0.3)',
                            ...
                            return (
                                <div key={car.id} className="promo-card" style={{
                                    ...
                                    <div className="promo-card-info" style={{ padding: '1.2rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <div className="promo-price-box" style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: '0.8rem', background: 'rgba(230,0,0,0.05)', padding: '6px 10px', borderRadius: 10, border: '1px solid rgba(230,0,0,0.1)' }}>
                                            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#ff3b3b', animation: 'pulse 1.5s infinite' }} />
                                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                                <span style={{ fontWeight: 900, fontSize: '1.4rem', color: '#ff3b3b', lineHeight: 1 }}>{formatPrice(car.price)} {currency}</span>
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                background: (!car.count || car.count <= 0) ? '#555' : 'linear-gradient(45deg,#b30000,#e60000)', color: '#fff',
                ...
                return allImgs.length > 0 && (
                    <div style={{
                        ...
                        <button onClick={() => setGalleryCar(null)} style={{
                            ...
                            zIndex: 10010
                        }} onMouseEnter={e => { e.currentTarget.style.background = 'rgba(230,0,0,0.4)'; }} onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.12)'; }}>✕</button>

                        {/* Car Name & Counter */}
                        <div style={{ textAlign: 'center', marginBottom: '1rem', zIndex: 1 }} onClick={e => e.stopPropagation()}>
                            <h2 style={{ color: '#e60000', fontSize: '1.6rem', fontWeight: 900, margin: 0 }}>{L(galleryCar.name)}</h2>
                        ...
                        {/* Main Image Viewer */}
                        <div
                            style={{ position: 'relative', width: '100%', maxWidth: 1000, flex: '1 1 auto', maxHeight: '65vh', background: '#050505', borderRadius: 18, overflow: 'hidden', border: '1px solid rgba(230,0,0,0.15)', boxShadow: '0 30px 80px rgba(0,0,0,0.8)' }}
                            onClick={e => e.stopPropagation()}
                        ...
                        >
                            ...
                            {allImgs.length > 1 && (<>
                                <button
                                    ...
                                    onMouseEnter={e => { e.currentTarget.style.background = 'rgba(230,0,0,0.7)'; }}
                            ...
                            {allImgs.length > 1 && (
                                <div style={{ position: 'absolute', bottom: '0.8rem', left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: 6 }}>
                                    {allImgs.map((_: string, idx: number) => (
                                        <div key={idx} onClick={() => setCurrentImgIndex(idx)} style={{ width: idx === currentImgIndex ? 20 : 8, height: 8, borderRadius: 4, background: idx === currentImgIndex ? '#e60000' : 'rgba(255,255,255,0.3)', cursor: 'pointer', transition: 'all 0.3s' }} />
                                    ))}
                                </div>
                            )}
                        </div>
                                ...
                                {allImgs.map((img: string, idx: number) => (
                                    <img
                                        ...
                                        style={{
                                            ...
                                            border: idx === currentImgIndex ? '2.5px solid #e60000' : '2.5px solid transparent',
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ textAlign: 'center', marginBottom: '0.5rem' }}>
                            ...
                            <h2 style={{ fontWeight: 900, fontSize: '1.1rem', color: '#e60000', marginBottom: '0.1rem' }}>{t('booking.title')}</h2>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem' }}>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onFocus={e => e.target.style.borderColor = '#e60000'} onBlur={e => e.target.style.borderColor = 'rgba(255,255,255,0.1)'}
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.6rem', flexDirection: t('dir') === 'rtl' ? 'row' : 'row-reverse' }}>
                                    ...
                                    <div style={{ flex: 1, textAlign: 'center', fontSize: '1.15rem', fontWeight: 900, color: '#e60000', direction: 'rtl' }}>{Math.max(db?.promoCars?.some((p: any) => L(p.name) === L(bookingCar?.name)) ? 5 : 1, bookingDays)} {lang === 'ar' ? 'يوم' : 'jours'}</div>
                                    <button onClick={() => {
                                ...
                                {db?.promoCars?.some((p: any) => L(p.name) === L(bookingCar?.name)) && (
                                    <div style={{ color: '#ff3b3b', fontSize: '0.65rem', marginTop: '0.2rem', textAlign: 'center', fontWeight: 700 }}>
                            ...
                            {(() => {
                                ...
                                return (
                                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem' }}>
                                        <div style={{ background: 'rgba(230,0,0,0.04)', border: '1px solid rgba(230,0,0,0.2)', borderRadius: 10, padding: '0.5rem 0.6rem' }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 6 }}>
                                                <div style={{ textAlign: 'center', flex: 1 }}>
                                                    ...
                                                    <div style={{ fontWeight: 800, color: '#e60000', fontSize: '0.68rem' }}>{startStr}</div>
                                                </div>
                                        ...
                                        <div style={{ background: 'rgba(230,0,0,0.05)', border: '1px dashed rgba(230,0,0,0.3)', borderRadius: 10, padding: '0.5rem 0.6rem', textAlign: 'center', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                            <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.5)', marginBottom: '0.1rem' }}>{t('booking.total')}</div>
                                            <div style={{ fontSize: '1.15rem', fontWeight: 900, color: '#e60000' }}>{formatPrice(bookingCar.price * bookingDays)} {currency}</div>
                                        </div>
                                    </div>
                                );
                            })()}
                            ...
                            <button
                                ...
                                style={{ padding: '0.6rem', borderRadius: 10, border: 'none', background: 'linear-gradient(45deg,#b30000,#e60000)', color: '#fff', fontWeight: 800, fontSize: '0.85rem', cursor: 'pointer', boxShadow: '0 6px 14px rgba(230,0,0,0.2)', transition: 'all 0.3s' }}
